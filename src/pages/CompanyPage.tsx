    ...
    <div className="space-y-6 max-w-4xl">
          ...
          {isEditingCurrent ? (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-1.5">
                  <Label className="text-xs text-slate-700 dark:text-slate-300">CNPJ</Label>
                  <Input
                    value={cnpj}
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-1.5 col-span-2">
                  <Label className="text-xs text-slate-700 dark:text-slate-300">Endereço</Label>
                  <Input
                    value={address}
          ...
          {companies.map((c) => (
            <div
              ...
              className={`p-4 flex items-center justify-between gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/40 transition ${
                company?.id === c.id ? 'bg-blue-50/50 dark:bg-blue-950/20' : ''
              }`}
            >
              ...
              <div className="flex items-center gap-2">
                {company?.id !== c.id && (
                  <Button
                    ...
                    className="border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-950 text-blue-600 dark:text-blue-400 hover:text-white hover:bg-blue-600 text-xs h-8"
                  >
                ...
                {isAdmin && (
                  <Button
                    ...
                    className="border-red-300 dark:border-red-900/50 bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 hover:bg-red-600 hover:text-white text-xs h-8 px-2.5 transition"
      ...
      >
        <DialogContent className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white max-w-md">
          ...
          <div className="py-3 text-slate-600 dark:text-slate-300 text-sm leading-relaxed space-y-3">
            <p>
            ...
            <div className="p-3 rounded-md bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/40 text-red-700 dark:text-red-300 text-xs flex items-start gap-2">
      ...
      <Dialog open={isNewTenantModalOpen} onOpenChange={setIsNewTenantModalOpen}>
        <DialogContent className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white max-w-md">
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-1.5">
              <Label className="text-xs text-slate-700 dark:text-slate-300">Razão Social *</Label>
              <Input
                value={newCompName}
            ...
            <div className="space-y-1.5">
              <Label className="text-xs text-slate-700 dark:text-slate-300">Nome Fantasia</Label>
              <Input
                value={newCompTrade}
